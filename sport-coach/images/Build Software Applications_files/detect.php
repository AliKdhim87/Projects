...
this.browser = new Browser({ stock: false, hidden: false, channel: "Dev", mode: "", name: "Chrome", version: new Version({ value: "75.0.3770.142" }) });
this.engine = new Engine({ name: "Blink", version: new Version({ value: "537.36" }) });
this.os = new Os({ name: "Windows", version: new Version({ value: "10.0", alias: "10" }) });
